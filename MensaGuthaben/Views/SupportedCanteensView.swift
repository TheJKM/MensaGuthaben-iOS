...
struct SupportedCanteensView: View {
    let supported: [String] = ["HS Aschaffenburg", "Uni Bamberg", "TU Braunschweig", "TU Darmstadt", "h_da Darmstadt", "TU Dresden Emeal", "Uni Gießen", "TU Ilmenau", "Uni Saarland", "FH Würzburg", "Uni Würzburg"]
